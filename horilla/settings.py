...
ALLOWED_HOSTS = ['hrms.pazl.info', 'localhost', '127.0.0.1']
...
DATABASES = {
    "default": {
        ...
        "NAME": env("DB_NAME", default="your_database_name"),
        "USER": env("DB_USER", default="your_database_user"),
        "PASSWORD": env("DB_PASSWORD", default="your_database_password"),
        "HOST": env("DB_HOST", default="127.0.0.1"),
        "PORT": env("DB_PORT", default="3306"),
        "OPTIONS": {
            "init_command": "SET SESSION wait_timeout=1200;",
